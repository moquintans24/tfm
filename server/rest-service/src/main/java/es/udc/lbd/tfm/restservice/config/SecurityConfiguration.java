package es.udc.lbd.tfm.restservice.config;
...
import es.udc.lbd.tfm.restservice.security.MyAccessDeniedHandler;
import es.udc.lbd.tfm.restservice.security.MyUnauthorizedEntryPoint;
import es.udc.lbd.tfm.restservice.security.MyUserDetailsService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.csrf().disable().exceptionHandling()
      ...
      .antMatchers(HttpMethod.GET, "/api/**").permitAll() //solo para las pruebas
//      .antMatchers(HttpMethod.POST, "/api/**").permitAll()  //solo para las pruebas
//      .antMatchers(HttpMethod.PUT, "/api/**").permitAll()  //solo para las pruebas
